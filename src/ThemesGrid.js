			...
			<div className="relative mx-auto max-w-7xl px-4 sm:static sm:px-6 lg:px-8">
				<div className="sm:max-w-lg">
					...
					<p className="mt-4 text-xl text-gray-500">
						Choose a theme and click to reveal the crafted ASCII art hidden
						beneath. Sharpen your senses and let your imagination decode the
						canvas. Ready, set, guess!
					</p>
				</div>
			</div>
				...
				<div className="lg:flex lg:items-start lg:justify-between">
					<div className="grid grid-cols-3 gap-2 sm:gap-4 lg:flex-1">
						{themes.map((theme, index) => (
							<button
								key={index}
								className={`overflow-hidden rounded-3xl transform transition duration-300 hover:scale-110 flex justify-center items-center ${
